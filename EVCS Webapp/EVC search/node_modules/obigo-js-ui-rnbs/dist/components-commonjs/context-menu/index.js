...
module.exports = function(modules) {
    ...
    exports.default = {
        ...
        mounted: function mounted() {
            ...
            this.$nextTick(function() {
                _this.$el.childNodes[2].removeChild(_this.$dim);
                _this.$el.childNodes[2].removeChild(_this.$closeButton);
            });
        },
    ...
    __vue_options__.render = __vue_template__.render;
    __vue_options__.staticRenderFns = __vue_template__.staticRenderFns;
    __vue_options__._scopeId = "data-v-072ba112";
    module.exports = __vue_exports__;
}, function(module, exports, __webpack_require__) {
    var __vue_exports__, __vue_options__;
    var __vue_styles__ = {};
    ...
    module.exports = {
        render: function() {
            ...
            return _c("obg-button", {
                ref: "origin",
                attrs: {
                    icon: _vm.icon,
                    type: _vm.btnType
                }
            }, [ _vm._t("icon"), _vm._v(" "), _c("obg-popover", {
                ref: "popover",
                ...
                on: {
                    open: _vm.showDimScreen,
                    close: _vm.hideDimScreen
                }
                ...
                return _c("div", {
                    directives: [ {
                        ...
                        expression: "{zone: 1, order: index + 1}"
                    } ],
                ...
                ref: "closeButton",
                staticClass: "close-button animate-scale"
            }, [ _c("i", {
                staticClass: "obg-icon-close"
            }) ]) ], 2);
        },
        staticRenderFns: []
    };
    ...
    module.exports = {
        render: function() {
            ...
            return _c("button", {
                ...
                class: [ "obg-button-" + _vm.type, "obg-button-" + _vm.size, {
