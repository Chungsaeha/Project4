...
module.exports = function(modules) {
    ...
    var parentMixin = {
        ...
        computed: {
            ...
            slideWidth: function slideWidth() {
                ...
                var sw = parseInt(this.width + this.border * 2, 10);
                return vw < sw ? vw : sw;
            },
            slideHeight: function slideHeight() {
                var sw = parseInt(this.width + this.border * 2, 10);
                var sh = parseInt(this.height + this.border * 2, 10);
            ...
            leftIndices: function leftIndices() {
                var n = Math.floor(this.visible / 2) + 1;
                var indices = [];
                for (var m = 1; m < n; m++) {
    ...
    var IObject = __webpack_require__(8), defined = __webpack_require__(7);
    module.exports = function(it) {
    ...
    var _coverFlow = __webpack_require__(5);
    exports.default = {
        name: "obg-cover-flow-portrait",
        mixins: [ _coverFlow.parentMixin ],
        props: {
            perspective: {
                type: Number,
                default: 35
    ...
    exports.default = {
        ...
        computed: {
            ...
            slideStyle: function slideStyle() {
                var styles = {};
                if (!this.isCurrent) {
                    var rIndex = this.getSideIndex(this.parent.rightIndices);
                    var lIndex = this.getSideIndex(this.parent.leftIndices);
                ...
                return (0, _assign2.default)(styles, {
        ...
        methods: {
            calculatePosition: function calculatePosition(i, positive) {
                var adjustVal = i === 0 ? 5 : -5;
                var topRemain = this.parent.space === "auto" ? parseInt((i + 1) * (this.parent.height / .8), 10) : parseInt((i + 1) * this.parent.space, 10);
                var transform = positive ? "translateX(-" + (50 + i * 10) + "px)" + "translateY(" + (topRemain + 18 + adjustVal) + "px) translateZ(-" + (this.parent.inverseScaling + (i + 2) * 100) + "px) " : "translateX(-" + (50 + i * 10) + "px)" + "translateY(-" + (topRemain + 25 + adjustVal) + "px) translateZ(-" + (this.parent.inverseScaling + (i + 2) * 100) + "px) ";
                var top = this.parent.space === "auto" ? this.viewportCenter : parseInt((i + 1) * this.parent.space);
                return {
                    transform: transform,
                    top: top
                };
    ...
    exports.coverSlide = exports.coverFlowPortrait = undefined;
    ...
    exports.coverFlowPortrait = _Carousel2.default;
    exports.coverSlide = _Slide2.default;
}, function(module, exports, __webpack_require__) {
    module.exports = {
    ...
    var toIObject = __webpack_require__(10), toLength = __webpack_require__(37), toIndex = __webpack_require__(36);
    ...
    var global = __webpack_require__(3), core = __webpack_require__(6), ctx = __webpack_require__(20), hide = __webpack_require__(25), PROTOTYPE = "prototype";
    ...
    var dP = __webpack_require__(28), createDesc = __webpack_require__(33);
    ...
    "use strict";
    var getKeys = __webpack_require__(31), gOPS = __webpack_require__(29), pIE = __webpack_require__(32), toObject = __webpack_require__(38), IObject = __webpack_require__(8), $assign = Object.assign;
    ...
    var anObject = __webpack_require__(17), IE8_DOM_DEFINE = __webpack_require__(26), toPrimitive = __webpack_require__(39), dP = Object.defineProperty;
    ...
    var has = __webpack_require__(24), toIObject = __webpack_require__(10), arrayIndexOf = __webpack_require__(18)(false), IE_PROTO = __webpack_require__(34)("IE_PROTO");
    ...
    var $keys = __webpack_require__(30), enumBugKeys = __webpack_require__(22);
    ...
    var toInteger = __webpack_require__(9), max = Math.max, min = Math.min;
    module.exports = function(index, length) {
        index = toInteger(index);
        return index < 0 ? max(index + length, 0) : min(index, length);
    };
}, function(module, exports, __webpack_require__) {
    var toInteger = __webpack_require__(9), min = Math.min;
    module.exports = function(it) {
    ...
    __vue_options__._scopeId = "data-v-5e2978c8";
    ...
    __vue_options__.render = __vue_template__.render;
    __vue_options__.staticRenderFns = __vue_template__.staticRenderFns;
    __vue_options__._scopeId = "data-v-4c1e92a5";
    module.exports = __vue_exports__;
}, function(module, exports) {
    module.exports = {
        render: function() {
            ...
            return _c("div", {
                staticClass: "obg-carousel-slide",
                class: {
                    current: _vm.isCurrent
                },
                style: _vm.slideStyle,
                attrs: {
                    "data-label-width": _vm.labelWidth,
    ...
    module.exports = {
        render: function() {
            ...
            var _c = _vm._self._c || _h;
            return _c("div", {
                staticClass: "obg-carousel-container"
            }, [ _c("div", {
                staticClass: "obg-carousel-slider"
            }, [ _vm._t("default") ], 2) ]);
        },
        staticRenderFns: []
    };
